...
"    public $defs;\n"
"    public $enums;\n\n"
"    function __construct($id, $name, $pkgs, $enums, $defs) {\n"
"      $this->id = $id;\n"
"      $this->name = $name;\n"
"      $this->pkgs = $pkgs;\n"
"      $this->defs = $defs;\n"
...
"    public $type;\n"
"    public $cols;\n\n"
"    function __construct($name, $type, $cols) {\n"
"      $this->name = $name;\n"
"      $this->type = $type;\n"
"      $this->cols = $cols;\n"
"    }\n"
...
static void gen_col_list(FILE *file, bs_col_list *cols, int level) {
    ...
    for (i = 0; i < cols->len; i++) {
        ...
        TAB();
        fprintf(file, "new bs_col('%s', %s, array(", col->name, get_php_type(col->type));
...
char *get_php_type(bs_type type) {
    switch (type) {
        ...
        case BS_TE8:  return "bs_type::enum8";
        case BS_TE16: return "bs_type::enum16";
        case BS_TE32: return "bs_type::enum32";
        case BS_TE64: return "bs_type::enum64";
